                    ...
                    <nav className="menu rounded-md">
                        <section className="menu-section px-4">
                            <ul className="menu-items">
								<Link href="/dashboard" className={`menu-item ${router === '/guru/dashboard' ? 'menu-active' : 'bg-transp hover:bg-transparent'} `}>
								...
								<Link href="/task" className={`menu-item ${router === '/guru/task' ? 'menu-active' : 'bg-transparent hover:bg-transparent'} `}>
                                ...
                                <Link href="/program" className={`menu-item  ${router === '/guru/program' ?'menu-active':'bg-transparent hover:bg-transparent'} `}>
