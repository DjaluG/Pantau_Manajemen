                    ...
                    <nav className="menu rounded-md">
                        <section className="menu-section px-4">
                            <ul className="menu-items">
								<Link href="/ks/dashboard" className={`menu-item ${router === '/dashboard' ? 'menu-active' : 'bg-transp hover:bg-transparent'} `}>
								...
								<Link href="/ks/task" className={`menu-item ${router === '/task' ? 'menu-active' : 'bg-transparent hover:bg-transparent'} `}>
                                ...
                                <Link href="/ks/program" className={`menu-item  ${router === '/program' ?'menu-active':'bg-transparent hover:bg-transparent'} `}>
