                    ...
                    <nav className="menu rounded-md">
                        <section className="menu-section px-4">
                            <ul className="menu-items">
								<Link href="/ks/dashboard" className={`menu-item ${router === '/ks/dashboard' ? 'menu-active' : 'bg-transp hover:bg-transparent'} `}>
								...
								<Link href="/ks/task" className={`menu-item ${router === '/ks/task' ? 'menu-active' : 'bg-transparent hover:bg-transparent'} `}>
                                ...
                                <Link href="/ks/program" className={`menu-item  ${router === '/ks/program' ?'menu-active':'bg-transparent hover:bg-transparent'} `}>
