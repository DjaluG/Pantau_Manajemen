          ...
          <nav className="menu rounded-md">
            <section className="menu-section px-4">
              <ul className="menu-items">
                <Link
                  href="/guru/dashboard"
                  className={`menu-item transition-all duration-500 ${!isOpen && 'flex justify-center'} ${router === "/guru/dashboard"
                    ? "menu-active"
                ...
                <Link
                  href="/guru/program"
                  className={`menu-item transition-all duration-500 ${!isOpen && 'flex justify-center'} ${router === "/guru/program"
                    ? "menu-active"
                ...
                <Link
                  href="/guru/task"
                  className={`menu-item transition-all duration-500 ${!isOpen && 'flex justify-center'} ${router === "/guru/task"
                    ? "menu-active"
                    : "bg-transparent hover:bg-transparent"
                    } `}
                >
