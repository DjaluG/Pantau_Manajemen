                    ...
                    <nav className="menu rounded-md">
                        <section className="menu-section px-4">
                            <ul className="menu-items">
								<Link href="/guru/dashboard" className={`menu-item ${router === '/guru/dashboard' ? 'menu-active' : 'bg-transp hover:bg-transparent'} `}>
								...
								<Link href="/guru/task" className={`menu-item ${router === '/guru/task' ? 'menu-active' : 'bg-transparent hover:bg-transparent'} `}>
                                ...
                                <Link href="/guru/program" className={`menu-item  ${router === '/guru/program' ?'menu-active':'bg-transparent hover:bg-transparent'} `}>
